...
class controllerQuiz extends Controller
{
    ...
    public function dadosPagina5(Request $request){
        ...
        $acertos = session('acertos');
        if ($acertos == 5)    
            $dados['mensagem'] = "Excelente! Acertou todas! Você é incrível!";
        else if ($acertos > 2)
            $dados['mensagem'] = "Bom! Acertou " . $acertos . " de 5, você é incrível!";
        else
            $dados['mensagem'] = "Péssimo, se intere mais sobre o assunto! Você acertou " . $acertos ."";
